...
serper_dev_tool=SerperDevTool(api_key="c1459672b8e6c28d97027168a689a0f47909ea5c")
...
def agent_invocation(payload, context):
    ...
    try:
        # Extract user input from payload. This is default destination if nothing is provided
